# TTL-VGA
This project was inspired by Ben Eater's attempt at "Creating The Worst Video Card" video, where he modeled a 640x480 pixel VGA screen driver, using 7400-series TTL logic ICs. The following project attempts to expand aforementioned screen driver's capability, by enabling it to access the same RAM used by CPU for processing data via interrupt mechanism.
